...
import {
    FaCoffee, FaUtensils, FaTree, FaLandmark, FaShoppingBag, FaBasketballBall, FaQuestion,
    FaUserGraduate, FaBriefcase, FaUserTie, FaUserClock, FaUserAltSlash, FaUser
} from "react-icons/fa";
...
const QuestionnairePage = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            // Add the user object to the payload
            const payload = {
                ...form,
                user: { id: 1 } // <-- Replace 1 with the actual user ID if dynamic
            };
    ...
    return (
        <main className="flex flex-col items-center bg-background-default min-h-screen p-2 sm:p-4">
            ...
            >
                ...
                <div>
                    <label className="block text-base sm:text-lg font-semibold mb-2">Which types of places are you most interested in visiting?</label>
                ...
                {/* Usual Places */}
                <div>
                    <label className="block text-base sm:text-lg font-semibold mb-2">What places do you usually go to?</label>
                    <textarea
                        name="usualPlaces"
